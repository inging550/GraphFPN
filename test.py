...
from net.pyramid import GraphFeaturePyramid
from utils.utils import ModelEMA
from torch.cuda import amp

def get_args():
  parser = argparse.ArgumentParser('GraphFPN', add_help=False)
  parser.add_argument("--epoch", type=int, default=100)
  parser.add_argument('--batch_size', type=int, default=16)
  parser.add_argument('--nw', type=int, default=0)
  parser.add_argument('--label_path', type=str, default='/home/featurize/data/labels')
...
def main(args):
  ...
  # 定义网络，损失函数以及优化器
  net = GraphFeaturePyramid(args.batch_size, class_num=80, phi='n')
